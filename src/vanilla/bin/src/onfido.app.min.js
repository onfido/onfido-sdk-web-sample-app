!(function (t, e) {
  ...
  return (function (t) {
      ...
      if (0 !== n)
        if (n) e.push(n[2])
          ...
          ;(a.charset = 'utf-8'),
            ...
            (a.src = (function (t) {
              return o.p + '' + t + '.onfido.app.min.js'
            })(t))
          var u = new Error()
          s = function (e) {
    ...
    var i = (window.webpackJsonpOnfidoSampleApp =
        window.webpackJsonpOnfidoSampleApp || []),
      s = i.push.bind(i)
    ;(i.push = e), (i = i.slice())
    ...
    function (t, e, n) {
      ;(window.onload = async function () {
        const { init: t } = await Promise.all([n.e(1), n.e(2)]).then(
          n.t.bind(null, 6, 7)
        )
        ;((t) => {
          const e = new XMLHttpRequest()
          e.open('GET', 'https://token-factory.onfido.com/sdk_token', !0),
            e.setRequestHeader(
              'Authorization',
          ...
          window.onfidoOut = t({
            ...
            onComplete: function (t) {
              console.log('Everything is complete', t)
            },
            steps: [
              {
                type: 'welcome',
...
//# sourceMappingURL=onfido.app.min.js.map
